...
Public Class Form1
    ...
    Private Sub ListView()
        ...
        Try
            Call OpenKoneksi()
            Dim query_id As String = "select * from TPengajuan"
    ...
    Private Sub BTsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTsave.Click
        ...
        If BTsave.Text = "save" Then
            Try
                Call OpenKoneksi()
                Dim query_id As String = "select MAX(id)+1 AS MXID from TPengajuan"
                cmd = New SqlCommand(query_id, conn)
                dr = cmd.ExecuteReader
                dr.Read()
                uid = dr("MXID")
                ...
                query = "Insert into TPengajuan (id,nama_pelaksana,bidang,jml_permintaan,bentuk_dana,keperluan,tanggal) Values(" & uid & ",'" & TbNama.Text & "','" & CBbidang.Text & "','" & TBpermintaan.Text & "','" & bentuk & "','" & TBkeperluan.Text & "','" & tanggal & "')"
        ...
        ElseIf BTsave.Text = "Update" Then
            ...
            ElseIf RBgiro.Checked = True Then
                bentuk = RBgiro.Text
            End If
            query = "Update TPengajuan Set nama_pelaksana='" & TbNama.Text & "',bidang='" & CBbidang.Text & "',jml_permintaan='" & TBpermintaan.Text & "',bentuk_dana='" & bentuk & "',keperluan='" & TBkeperluan.Text & "'Where id='" & TBID.Text & "'"
    ...
    Private Sub BTEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTEdit.Click
        ...
        Try
            ...
            Call OpenKoneksi()
            query = "Select * from TPengajuan Where id='" + id + "'"
    ...
    Private Sub BTDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTDelete.Click
        ...
        If MsgBox("Apakah Anda Yakin Ingin Menghapusnya?", vbYesNo) = MsgBoxResult.Yes Then
            Try
                id = LVpengajuan.SelectedItems(0).Text
                Call OpenKoneksi()
                Dim query As String = "Delete from TPengajuan Where id='" + id + "'"
